//
// Created by benjamin on 08.07.22.
//

#ifndef ROBOT_FIBONACCIHEAP_H
#define ROBOT_FIBONACCIHEAP_H
...
namespace RobbyTheRobot {
    ...
    public:
        ...
        public:
            FibNode(T k, void *pl)
                    : key(std::move(k)), mark(false), parent(nullptr), left(nullptr), right(nullptr), child(nullptr),
                      degree(-1),
                      payload(pl) {
            }
